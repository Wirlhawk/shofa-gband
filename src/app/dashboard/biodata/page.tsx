  ...
  const members = [
    {
      ...
      funFact:
        "Idol pertama asal Indonesia yang debut di bawah SM Entertainment.",
    ...
    },
    {
      ...
      hobbies: "Balet",
      funFact:
        "Memiliki tinggi badan 170 cm dan latar belakang sebagai penari balet.",
    ...
    },
    {
      ...
      funFact:
        "Dikenal memiliki visual yang menawan dan diprediksi menjadi face of the group.",
    ...
    },
    {
      ...
      funFact:
        "Dikenal sebagai ace grup dengan kemampuan menyanyi, menari, dan rap.",
              ...
              <div className="p-5">
                ...
                <div className="flex items-center mb-2">
                  ...
                  <p className="text-sm text-gray-600">
                    {member.birthdate} - {member.zodiac}
                  </p>
                </div>
